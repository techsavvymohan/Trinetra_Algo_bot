"""Test NAS100 realistic institutional alpha with zero artificial index commission."""
import os
import sys
import json
...
def test_nas_alpha():
    ...
    cfg.trading.nas_stagnation_bars = 35

    # Test with standard index commission (0.0 or 0.10/contract):
    ...
    print("="*75)
    print(f"  NAS100 REALISTIC ALPHA TEST")
    print("="*75)
